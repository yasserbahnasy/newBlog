                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="Setting">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            <label for="description" class="col-md-4 control-label">Website Description</label>
                        ...
                        <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="text" class="form-control" name="url" value="{{ $setting->url }}" required>
